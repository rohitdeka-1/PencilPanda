    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6 md:p-10 space-y-6">
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-purple-700 mb-3">3.1 Order Processing Time</h2>
            <p className="text-sm md:text-base text-gray-700">Orders are processed within 1–2 business days.</p>
          </section>

          <section>
            <h2 className="text-lg md:text-xl font-bold text-purple-700 mb-3">3.2 Delivery Time (Shiprocket)</h2>
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-purple-700 mb-3">3.3 Shipping Partners</h2>
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-purple-700 mb-3">3.4 Tracking</h2>
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-purple-700 mb-3">3.5 Delays</h2>
