    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6 md:p-10 space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-700 mb-4">2.1 Information We Collect</h2>
            <p className="text-gray-700 mb-3">When you use our website, we collect:</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-700 mb-4">2.2 How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-700 mb-4">2.3 Data Protection</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-700 mb-4">2.4 Sharing of Information</h2>
            ...
            <p className="text-gray-700 mt-4 font-semibold">We never sell your data.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-purple-700 mb-4">2.5 Your Rights</h2>
